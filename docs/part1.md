...
*Интерфейсы репозитория, используемые для скрытия деталей базовой реализации.
...
заменять части логики репозиториев, предназначенным только для тестирования, что
